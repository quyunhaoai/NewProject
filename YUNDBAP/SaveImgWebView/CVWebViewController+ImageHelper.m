...
@implementation DLPanableWebView (ImageHelper)
...
- (void)FSActionSheet:(FSActionSheet *)actionSheet selectedIndex:(NSInteger)selectedIndex
{
    ...
    switch (selectedIndex) {
        ...
        case SelectItemQRExtract:
        {
            ...
            NSRange httpRange = [self.qrCodeString rangeOfString:@"http"];
            if (httpRange.location != NSNotFound) {
                [self loadRequest:[NSURLRequest requestWithURL:qrUrl]];
                
            }else {
                [UIAlertView showAlertViewWithTitle:NSLocalizedString(@"goodInfo", nil) message:self.qrCodeString cancelButtonTitle:NSLocalizedString(@"ensure", nil) otherButtonTitles:nil onDismiss:^(int buttonIndex, UIAlertView *alertView) {

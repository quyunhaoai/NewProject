...
- (void)updateTimeLabel
{
    ...
    // 3.显示日期
    self.lastUpdateTimeLabel.text = [NSString stringWithFormat:@"%@：%@",NSLocalizedString(@"endRefesh", nil), time];
}
...
- (void)adjustStateWithContentOffset
{
    ...
    float moveY = fabsf(self.scrollView.contentOffset.y);
    if (moveY > 65)
        moveY = 65;
...
#pragma mark -这句代码修复了，top值不断累加的bug-

//
//  HwThreeViewController.m
//  NewCloudApp
//
//  Created by hw on 16/1/20.
//
//
...
@interface HwThreeViewController ()

@end

@implementation HwThreeViewController
...
- (void)viewDidLayoutSubviews {
    ...
    if ([sssBase.titleBarIsShow isEqualToString:@"0"] && [sssBase.adaptIOS7Nav isEqualToString:@"1"] && self.navigationController.navigationBarHidden) {
        self.view.backgroundColor = [HwTools hexStringToColor:sssBase.titleBarColor];
        if (self.wkWebView) {
            CGRect webViewRect = self.wkWebView.frame;

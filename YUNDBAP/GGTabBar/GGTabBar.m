...
- (void)setSelectedButton:(UIButton *)selectedButton
{
    ...
    if (oldButtonIndex != NSNotFound) {
        ...
        if (!self.isShowTitle) {
            ...
            [_selectedButton setTitleColor:[UIColor colorWithWhite:0.205 alpha:1.000] forState:UIControlStateNormal];
        }
...
- (void)initSubViewsWithControllers:(NSArray *)viewControllers
{
    ...
    for (UIViewController *viewController in viewControllers) {
        ...
        if (!self.isShowTitle) {
            ...
            [button setTitleColor:[UIColor colorWithWhite:0.205 alpha:1.000] forState:UIControlStateNormal];
